                ...
                <div class="row justify-content-md-center">
                  @if ($ads->image)
                    <div class="col col-md-3">
                        ...
                        <div class="form-group">
                          <img src="{{ Storage::url($ads->image) }}" class="avatar img img-thumbnail" alt="avatar">
                  ...
                  @if ($ads->video_url)
                    <div class="col col-md-3">
                      <!-- video -->
                      <div class="form-group">
                        <video src="{{ Storage::url($ads->video_url) }}" width="200" height="auto" controls></video>
